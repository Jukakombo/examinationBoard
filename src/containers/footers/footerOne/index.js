        ...
        <div className="container">
          <div className="row">
            ...
            <div className="col-lg-2 offset-lg-1 col-md-6 col-sm-6 col-12 sm__mt--40 md__mt--40">
              <div className={styles.singleWidget}>
                <h2 className={styles.ftTitle}>NEC Info</h2>
                <ul className={styles.ftContactLink}>
                  <li>
                    <Link to={process.env.PUBLIC_URL + "#/"}>Why NEC</Link>
                  </li>
                  <li>
                    <Link to={process.env.PUBLIC_URL + "#/"}>
                      Voopo Pricing
            ...
            <div className="col-12 col-sm-6">
              <div className={styles.copyrightInner}>
                <p className="copyright-text">
                  &copy; NEC 2022 - {new Date().getFullYear()} Developed By:
                  Remit Capital Limited
                </p>
              </div>
            </div>
            <div className="col-12 col-sm-6">
